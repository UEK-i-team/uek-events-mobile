...
//         </ThemedText>
//         <ThemedText style={[styles.notFoundText, { color: "#666666" }]}>
...
//                 const tagColor = getTagColor(index + 3);
//                 return (
//                   <View
//                     key={index}
//                     style={[
...
//               <MaterialIcons name="calendar-today" size={20} color="#687076" />
//               <ThemedText style={[styles.detailText, { color: "#666666" }]}>
//                 {event.date}
//               </ThemedText>
//               <MaterialIcons
//                 name="access-time"
...
//           <View style={styles.detailSection}>
//             <View style={styles.detailRow}>
//               <MaterialIcons name="location-on" size={20} color="#687076" />
//               <ThemedText
//                 style={[styles.detailText, { color: "#666666", flex: 1 }]}
//               >
//                 {event.location}
//               </ThemedText>
//             </View>
...
//             <View style={styles.detailSection}>
//               <View style={styles.detailRow}>
//                 <MaterialIcons name="people" size={20} color="#687076" />
//                 <ThemedText style={[styles.detailText, { color: "#666666" }]}>
//                   {event.entranceFee}
...
//                     <View
//                       style={[styles.bullet, { backgroundColor: "#1976D2" }]}
//                     />
//                     <ThemedText
//                       style={[
//                         styles.summaryText,
...
//             <View style={styles.section}>
//               <View style={styles.sectionHeader}>
//                 <MaterialIcons name="subject" size={24} color="#1976D2" />
//                 <ThemedText style={[styles.sectionTitle, { color: textColor }]}>
//                   Tematy:
//                 </ThemedText>
//               </View>
...
//                 </ThemedText>
//               </View>
//               <ThemedText style={[styles.organizerText, { color: "#666666" }]}>
...
//         style={[
//           styles.bottomBar,
//           { backgroundColor, borderTopColor: "#E0E0E0" },
//         ]}
//       >
//         <TouchableOpacity
